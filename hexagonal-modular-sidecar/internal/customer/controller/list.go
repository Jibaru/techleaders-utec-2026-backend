...
import (
	...
	sharedview "hexagonal-modular-sidecar/internal/shared/view"
)
...
func (c *Controller) List(w http.ResponseWriter, r *http.Request) {
	...
	httpx.WriteJSON(w, http.StatusOK, customerview.ListResponse{
		Data: data,
		Meta: sharedview.ListMeta{Page: out.Page, Limit: out.Limit, Total: out.Total, TotalPages: out.TotalPages},
	})
}
